...
const uint16_t PROGMEM ab_combo[] = {KC_A, KC_F, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [AF_TMUX] = COMBO(ab_combo, RCTL(KC_B)),
};
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NAVIGATION] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, LGUI(KC_LEFT), KC_NO, KC_PGUP, LGUI(KC_RIGHT), KC_NO, KC_BSPC, KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSG(KC_LEFT), KC_NO, KC_PGDN, LSG(KC_RIGHT), KC_MRWD, KC_MFFD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(3), KC_TRNS, KC_NO, KC_TRNS, KC_TRNS),
